...
interface LatestMobilesSectionProps {
  mobiles: Mobile[];
}

export default function LatestMobilesSection({ mobiles }: LatestMobilesSectionProps) {
  ...
  return (
    <section className="mb-8">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-1">Latest Mobiles Prices in Pakistan 2026</h2>
