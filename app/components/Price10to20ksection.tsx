...
export default function Price10to20kSection({ mobiles }: Price10to20kSectionProps) {
  ...
  return (
    <section className="mb-8">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-1">Mobile Phones price in Pakistan Rs. 10,000 - Rs. 20,000</h2>
