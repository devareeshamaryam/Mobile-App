...
interface Price20to30kSectionProps {
  mobiles: Mobile[];
}

export default function Price20to30kSection({ mobiles }: Price20to30kSectionProps) {
  ...
  return (
    <section className="mb-8">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-1">Mobile Phones price in Pakistan Rs. 20,000 - Rs. 30,000</h2>
