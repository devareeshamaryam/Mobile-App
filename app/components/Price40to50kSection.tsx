...
interface Price40to50kSectionProps {
  mobiles: Mobile[];
}

export default function Price40to50kSection({ mobiles }: Price40to50kSectionProps) {
  ...
  return (
    <section className="mb-8">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-1">Mobile Phones price in Pakistan Rs. 40,000 - Rs. 50,000</h2>
